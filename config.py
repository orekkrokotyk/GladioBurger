...
ingredients = {
    ...
    'rare': ["лук", "сыр", "свёкла", "горох", "сельдерей", "баклажан", "цветная_капуста", "пекинская_капуста",
             "кабачок", "фасоль", "брюква", "укроп", "лук-порей"],
    'epic': ["тыква", "архиса", "руклоа", "броколи", "редис", "петругшка", "корнишон", "острый_перец"],
    'legendary': ["авокадо", "брюсельская капуста", "патиссон", "манольд"],
    'mythical': ["крапива"]
}
...
all_i = ['томат-common', 'салат-common', 'огурец-common', 'солёный_огурец-common', 'морковь-common', 'чеснок-common',
         ...
         'фасоль-rare',
         'брюква-rare', 'укроп-rare', 'лук_порей-rare', 'тыква-epic', 'арахис-epic', 'рукола-epic', 'броколи-epic',
