...
ingredients = {
    ...
    'legendary': ["авокадо", "острый_перец"],
...
all_i = ['томат-common', 'салат-common', 'огурец-common', 'солёный_огурец-common', 'морковь-common', 'чеснок-common',
         ...
         'фасоль-rare',
         'брюква-rare', 'укроп-rare', 'лук_порей-rare',
         #'тыква-epic', 'арахис-epic', 'руккола-epic', 'брокколи-epic',
         #'редис-epic', 'петрушка-epic', 'корнишон-epic',
         'острый_перец-legendary', 'авокадо-legendary',
         #'брюсельская капуста-legendary', 'патиссон-legendary', 'мангольд-legendary',
         'крапива-mythical']
